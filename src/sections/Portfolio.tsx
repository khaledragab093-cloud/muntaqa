    ...
    <section id="portfolio" ref={sectionRef} className="relative py-24 overflow-hidden">
      ...
      <Dialog open={!!selectedVideo} onOpenChange={() => setSelectedVideo(null)}>
        <DialogContent className="glass-card border-gold/20 max-w-4xl p-0 overflow-hidden">
          <div className="aspect-video bg-black flex items-center justify-center w-full relative">
            {selectedVideo && getYouTubeEmbedUrl(selectedVideo.videoUrl) ? (
              ...
              <div className="text-center p-6">
                ...
                <p className="text-white/50 text-sm mt-2">عذراً، لا يوجد فيديو متاح لهذا العمل حالياً</p>
              </div>
            ) : null}
          </div>
          <div className="p-6">
